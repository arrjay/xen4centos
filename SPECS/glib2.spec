...
# Backports from glib-2-46 upstream
Patch2: 0001-GDBusProxy-Fix-a-memory-leak-during-initialization.patch
Patch3: 0001-GVariant-text-fix-scan-of-positional-parameters.patch
Patch4: 0001-file-monitors-reorder-some-code-to-avoid-segfault.patch
